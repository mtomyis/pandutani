	...
	<div class="wrapper"><header class="main-header"><a href="<?php echo base_url(); ?>dashboard" class="logo"><span class="logo-mini">
		...
		<nav class="navbar navbar-static-top" role="navigation"><a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button"><span class="sr-only">Toggle navigation</span>
			...
			<aside class="main-sidebar">
				...
				<li class="active"><a href="<?php echo base_url(); ?>petani"><i class="fa fa-file"></i> <span>Pengguna</span></a></li>
				<li class=""><a href="<?php echo base_url(); ?>pengingat"><i class="fa fa-file"></i> <span>Pengingat</span></a><!-- mulai dari sini -->
					...
					<section class="content-header"><h1>Pengguna</h1><ol class="breadcrumb"><li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Dashboard</a> </li>
						<li><a href="<?php echo base_url(); ?>petani">Pengguna</a> </li>
						<li class="active">Tambah</li></ol></section>
						<section class="content"><div class="row"><div class="col-md-12"><div class="box"><div class="box-header with-border"><h3 class="box-title">Tambah Prosedur</h3></div>
							<div class="box-body">
	<form action="<?php echo base_url(); ?>petani/simpan" class="form-horizontal" id="form-create_group" method="post" accept-charset="utf-8">
		<!-- <div class="form-group">
		<label for="id" class="col-sm-2 control-label">Id Petani</label>
		<div class="col-sm-10">
			<input type="text" name="idpetani" value="P" id="id" class="form-control"/>
		</div></div> -->
		<div class="form-group">
		<label for="nama" class="col-sm-2 control-label">Nama Depan</label>
		<div class="col-sm-10">
			<input type="text" name="nama_petani" value="" id="nama" class="form-control"/>
		</div></div>
		<div class="form-group">
		<label for="description" class="col-sm-2 control-label">Nama Belakang</label>
		<div class="col-sm-10">
			<input type="text" name="nama_belakang" value="" id="description" class="form-control"/>
		</div></div><div class="form-group">
		<label for="gambar" class="col-sm-2 control-label">Kata Sandi</label>
		<div class="col-sm-10">
			<input type="text" name="password_petani" id="gambar" class="form-control" />
		</div></div>
		<div class="form-group">
		<label for="gambarm" class="col-sm-2 control-label">Alamat</label>
		<div class="col-sm-10">
			<input type="text" name="alamat" id="gambarm" class="form-control"/>
		</div></div>
		<div class="form-group">
