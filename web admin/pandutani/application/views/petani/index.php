...
<body class="hold-transition skin-blue fixed sidebar-mini">
	...
	<section class="content-header"><h1>Pengguna</h1><ol class="breadcrumb"><li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Dashboard</a> </li><li class="active">Pengguna</li></ol></section>
			...
			<div class="col-md-12">
				<div class="box">
					<div class="box-header with-border col-md-10">
						<h3 class="box-title">
							<a href="<?php echo base_url(); ?>petani/tambah" class="btn btn-block btn-primary btn-flat"><i class="fa fa-plus">
							</i> Tambah</a></h3></div><div class="box-header with-border col-md-2">
						<!-- <h3 class="box-title">
							<a href="<?php echo base_url(); ?>diskusi/" class="btn btn-block btn-primary btn-flat"><i class="fa fa-users">
							</i> Diskusi</a></h3> --></div><div class="box-body">
	...
	<table class="table table-striped table-hover">
		...
		<tr>
			...
			<td> <?php echo $value->password_petani; ?> </td>
			<td> <?php echo $value->alamat; ?> </td>

			<td>
				<a href="<?php echo site_url('petani/edit/'.$value->idpetani); ?>">Edit</a> |&nbsp;
				<a href="<?php echo site_url('petani/hapus/'.$value->idpetani); ?>">Hapus</a>
