...
<body class="hold-transition skin-blue fixed sidebar-mini">
	<div class="wrapper"><header class="main-header"><a href="<?php echo base_url(); ?>dashboard" class="logo"><span class="logo-mini">
		...
		<nav class="navbar navbar-static-top" role="navigation"><a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button"><span class="sr-only">Toggle navigation</span>
			...
			<aside class="main-sidebar">
				<section class="sidebar"><!-- Sidebar menu --><ul class="sidebar-menu">
					<!-- mulai dari sini --><li class="header text-uppercase">Kelola Data</li>
				...
				<div class="content-wrapper">
					...
					<h1>Prosedur</h1><ol class="breadcrumb">
						<li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Dashboard</a> </li>
						<li><a href="<?php echo base_url(); ?>prosedur">Prosedur</a> </li><li class="active">Tambah</li></ol>
					</section>
		...
		<form action="<?php echo base_url(); ?>prosedur/simpan" class="form-horizontal" id="form-create_group" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		<!-- <div class="form-group">
		<label for="id" class="col-sm-2 control-label">Id Prosedur</label>
		<div class="col-sm-10">
			<input type="text" name="idprosedur" value="P" id="id" class="form-control"/>
		</div></div> -->
		<div class="form-group">
		<label for="nama" class="col-sm-2 control-label">Nama</label>
		<div class="col-sm-10">
			<input type="text" name="nama_prosedur" value="" id="nama" class="form-control"/>
		</div></div>
		<div class="form-group">
		<label for="description" class="col-sm-2 control-label">Deskripsi</label>
		<div class="col-sm-10">
			<textarea type="text" name="uraian_prosedur" value="" id="description" class="form-control"></textarea>
