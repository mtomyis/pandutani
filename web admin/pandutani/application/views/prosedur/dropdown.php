...
<body class="hold-transition skin-blue fixed sidebar-mini">
	<div class="wrapper"><header class="main-header"><a href="<?php echo base_url(); ?>dashboard" class="logo"><span class="logo-mini">
		...
		<section class="content-header"><h1>Prosedur</h1><ol class="breadcrumb">
			<li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Dashboard</a> </li>
			<li class="active">Prosedur</li></ol></section>
			<section class="content"><div class="row"><div class="col-md-12"><div class="box"><div class="box-header with-border">
				<h3 class="box-title"><a href="<?php echo base_url(); ?>prosedur/tambah" class="btn btn-block btn-primary btn-flat"><i class="fa fa-plus">
					</i> Tambah</a></h3>
							<br>
							<br>
							<form action="<?php echo base_url(); ?>prosedur/pilihdropdown" method="post">
	...
	<table class="table table-striped table-hover">
		...
		<tbody>
			<?php
		$no = 1;
		foreach ($data_prosedurs as $value) {
		?>

		<tr>
			<td> P<?php echo $no++; ?> </td>
			<td> <?php echo $value->nama_prosedur; ?> </td>
			<td> <?php echo $value->uraian_prosedur; ?> </td>
			<td><img height="100" width="100" src="<?php echo site_url('upload/'.$value->gambar_prosedur); ?>"></td>
			<td> <?php echo $value->nama_tanaman; ?> </td>

			<td>
				<a href="<?php echo site_url('prosedur/edit/'.$value->idprosedur); ?>">Edit</a> |&nbsp;
				<a href="<?php echo site_url('prosedur/hapus/'.$value->idprosedur); ?>">Hapus</a>
