...
<body class="hold-transition skin-blue fixed sidebar-mini">
	...
	<div class="box"><div class="box-header with-border"><h3 class="box-title">Tambah Prosedur</h3>
</div><div class="box-body">
	<form action="<?php echo base_url(); ?>pengingat/simpan" class="form-horizontal" id="form-create_group" method="post" accept-charset="utf-8">
		<!-- <div class="form-group">
		<label for="id" class="col-sm-2 control-label">Id Pengingat</label>
		<div class="col-sm-10">
			<input type="text" name="idpengingat" value="I" id="id" class="form-control"/>
		</div></div> -->
		<div class="form-group">
		<label for="nama" class="col-sm-2 control-label">Nama Pengingat</label>
		<div class="col-sm-10">
			<input type="text" name="nama_pengingat" value="" id="nama" class="form-control"/>
		</div></div>
		<div class="form-group">
		<label for="description" class="col-sm-2 control-label">Jarak Hari</label>
		<div class="col-sm-10">
			<input type="text" name="jarak_hst" value="" id="description" class="form-control"/>
		</div></div>
		<!-- <div class="form-group">
		<label for="gambar" class="col-sm-2 control-label">Tanggal Mulai</label>
		<div class="col-sm-10">
			<input type="text" name="tanggal_mulai" value="" id="gambar" class="form-control"/>
		</div></div>
		<div class="form-group">
		<label for="namha" class="col-sm-2 control-label">Tanggal Ahir</label>
		<div class="col-sm-10">
			<input type="text" name="tanggal_akhir" value="" id="namha" class="form-control"/>
		</div></div> -->
		<div class="form-group">
		<label for="namham" class="col-sm-2 control-label">Deskripsi</label>
		<div class="col-sm-10">
			<textarea type="text" name="ciri_tanaman" value="" id="namham" class="form-control"></textarea>
		</div></div>
		<!-- <div class="form-group">
		<label for="namhak" class="col-sm-2 control-label">Ciri Lahan</label>
		<div class="col-sm-10">
			<input type="text" name="ciri_lahan" value="" id="namhak" class="form-control"/>
		</div></div> -->
		<div class="form-group">
		<label for="fk" class="col-sm-2 control-label">FK Idtanaman Pangan</label>
		<div class="col-sm-10">
			<!-- ini seharusnya radiobutton -->
			...
			<!-- <input type="text" name="fk_idtanaman_pangan" value="T" id="fk" class="form-control"/> -->
		</div></div>
		<div class="form-group">
