				...
				<section class="sidebar"><!-- Sidebar menu --><ul class="sidebar-menu">
					...
					<div class="content-wrapper">
						<section class="content-header"><h1>Pengingat</h1><ol class="breadcrumb">
							...
							<li><a href="<?php echo base_url(); ?>pengingat">Pengingat</a> </li>
							<li class="active">Edit</li></ol></section>
	<section class="content"><div class="row"><div class="col-md-12">
	<div class="box">
		<div class="box-header with-border"><h3 class="box-title">Edit</h3> </div><div class="box-body">
	<form action="<?php echo base_url(); ?>pengingat/update" class="form-horizontal" id="form-create_group" method="post" accept-charset="utf-8">

		<!-- <div class="form-group">
		<label for="Idprosedur" class="col-sm-2 control-label">Id Pengingat</label>
		<div class="col-sm-10"> -->
			<input type="hidden" name="idpengingat" id="Idprosedur" class="form-control" value="<?php echo $data->idpengingat; ?>" />
		<!-- </div></div> -->
		<div class="form-group">
		<label for="nama" class="col-sm-2 control-label">nama</label>
		<div class="col-sm-10">
			<input type="text" name="nama_pengingat" id="nama" class="form-control"  value="<?php echo $data->nama_pengingat; ?>" />
		</div></div>
		<div class="form-group">
		<label for="description" class="col-sm-2 control-label">Jarak Hari</label>
		<div class="col-sm-10">
			<input type="text" name="jarak_hst" value="<?php echo $data->jarak_hst; ?>" id="description" class="form-control"/>
		</div></div>
		<!-- <div class="form-group">
		<label for="descrition" class="col-sm-2 control-label">Tanggal Mulai</label>
		<div class="col-sm-10">
			<input type="text" name="tanggal_mulai" value="<?php echo $data->tanggal_mulai; ?>" id="descrition" class="form-control"/>
		</div></div>
		<div class="form-group">
		<label for="descritionk" class="col-sm-2 control-label">Tanggal Akhir</label>
		<div class="col-sm-10">
			<input type="text" name="tanggal_akhir" value="<?php echo $data->tanggal_akhir; ?>" id="descritionk" class="form-control"/>
		</div></div> -->
		<div class="form-group">
		<label for="descritiokn" class="col-sm-2 control-label">Deskripsi</label>
		<div class="col-sm-10">
			<textarea type="text" name="ciri_tanaman" value="<?php echo $data->ciri_tanaman; ?>" id="descritiokn" class="form-control"><?php echo $data->ciri_tanaman; ?></textarea>
		</div></div>
		<!-- <div class="form-group">
		<label for="descritiona" class="col-sm-2 control-label">Ciri Lahan</label>
		<div class="col-sm-10">
			<input type="text" name="ciri_lahan" value="<?php echo $data->ciri_lahan; ?>" id="descritiona" class="form-control"/>
		</div></div> -->
		<div class="form-group">
		...
		<div class="col-sm-10">
			...
			<!-- <input type="text" name="fk_idtanaman_pangan" id="fk" class="form-control" value="<?php echo $data->fk_idtanaman_pangan; ?>" /> -->
		</div></div>
		<div class="form-group">
			<div class="col-sm-offset-2 col-sm-10">
				<div class="btn-group">
					...
					<a href="<?php echo base_url(); ?>pengingat" class="btn btn-default btn-flat">Cancel</a>
				</div>
			</div>
		</div>
