		...
		<nav class="navbar navbar-static-top" role="navigation"><a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button"><span class="sr-only">Toggle navigation</span>
			...
			<aside class="main-sidebar">
				<section class="sidebar"><!-- Sidebar menu --><ul class="sidebar-menu">
					...
					<li class="active"><a href="<?php echo base_url(); ?>tanamanpangan"><i class="fa fa-file"></i> <span>Tanaman Pangan</span></a></li>
					<li class=""><a href="<?php echo base_url(); ?>prosedur"><i class="fa fa-file"></i> <span>Prosedur</span></a></li><li class=""><a href="<?php echo base_url(); ?>hama"><i class="fa fa-file"></i> <span>Hama Tanaman</span></a></li>
				...
				<div class="content-wrapper">
					<section class="content-header"><h1>Tanaman pangan</h1><ol class="breadcrumb"><li><a href="<?php echo base_url(); ?>dashboard">
						<i class="fa fa-dashboard"></i> Dashboard</a> </li>
						<li><a href="<?php echo base_url(); ?>tanamanpangan">Tanaman pangan</a> </li>
						<li class="active">Edit</li></ol></section><section class="content"><div class="row"><div class="col-md-12">
			<div class="box"><div class="box-header with-border"><h3 class="box-title">Edit</h3>
		</div><div class="box-body">
			<form action="<?php echo base_url(); ?>tanamanpangan/update" class="form-horizontal" id="form-create_group" method="post" accept-charset="utf-8" enctype="multipart/form-data">

				<!-- <div class="form-group">
				<label for="Idtanaman" class="col-sm-2 control-label">Id Tanaman</label>
				<div class="col-sm-10"> -->
					<input type="hidden" name="idtanaman_pangan" id="Idtanaman" class="form-control" value="<?php echo $data->idtanaman_pangan; ?>" />
				<!-- </div></div> -->
				<div class="form-group">
				<label for="nama" class="col-sm-2 control-label">Nama</label>
				<div class="col-sm-10">
					<input type="text" name="nama_tanaman" id="nama" class="form-control"  value="<?php echo $data->nama_tanaman; ?>" />
				</div></div>
				<div class="form-group">
				<label for="description" class="col-sm-2 control-label">Deskripsi</label>
				<div class="col-sm-10">
					<textarea type="text" name="uraian_tanaman" value="<?php echo $data->uraian_tanaman; ?>" id="description" class="form-control"><?php echo $data->uraian_tanaman; ?></textarea>
				</div></div><div class="form-group">
				<label for="gambar" class="col-sm-2 control-label">Gambar</label>
				<div class="col-sm-10">
					<input type="file" name="gambar_tanaman" id="gambar" />
				</div></div>
				<div class="form-group">
					<div class="col-sm-offset-2 col-sm-10">
						<div class="btn-group">
							...
							<a href="<?php echo base_url(); ?>tanamanpangan" class="btn btn-default btn-flat">Cancel</a>
						</div>
					</div>
				</div>
