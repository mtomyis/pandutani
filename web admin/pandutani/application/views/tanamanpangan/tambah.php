			...
			<aside class="main-sidebar">
				<section class="sidebar"><!-- Sidebar menu --><ul class="sidebar-menu"><!-- mulai dari sini -->
					...
					<div class="content-wrapper">
						<section class="content-header"><h1>Tanaman pangan</h1><ol class="breadcrumb"><li><a href="<?php echo base_url(); ?>dashboard"><i class="fa fa-dashboard"></i> Dashboard</a> </li>
							<li><a href="<?php echo base_url(); ?>tanamanpangan">Tanaman pangan</a> </li><li class="active">Tambah</li></ol>
						</section>
					<section class="content"><div class="row"><div class="col-md-12">
						<div class="box"><div class="box-header with-border"><h3 class="box-title">Tambah Tanaman Pangan</h3>
					</div><div class="box-body">
						<form action="<?php echo base_url(); ?>tanamanpangan/simpan" class="form-horizontal" id="form-create_group" method="post" accept-charset="utf-8" enctype="multipart/form-data">
							<!-- <div class="form-group">
							<label for="Idtanaman" class="col-sm-2 control-label">Id Tanaman</label>
							<div class="col-sm-10">
								<input type="text" name="idtanaman_pangan" value="T" id="Idtanaman" class="form-control"/>
							</div></div> -->
							<div class="form-group">
							<label for="nama" class="col-sm-2 control-label">Nama</label>
							<div class="col-sm-10">
								<input type="text" name="nama_tanaman" value="" id="nama" class="form-control"/>
							</div></div>
							<div class="form-group">
							<label for="description" class="col-sm-2 control-label">Deskripsi</label>
							<div class="col-sm-10">
								<textarea type="text" name="uraian_tanaman" value="" id="description" class="form-control"></textarea>
							...
							<div class="form-group">
								<div class="col-sm-offset-2 col-sm-10">
									<div class="btn-group">
										<button name="submit" type="submit" class="btn btn-primary btn-flat" >Submit</button>
