...
<head><meta charset="UTF-8">
	<title>AdminLTE</title><!--[if IE 8]><meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1"><![endif]--><meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
		...
		<nav class="navbar navbar-static-top" role="navigation"><a href="#" class="sidebar-toggle" data-toggle="offcanvas" role="button"><span class="sr-only">Toggle navigation</span>
			...
			<aside class="main-sidebar">
				<section class="sidebar"><!-- Sidebar menu --><ul class="sidebar-menu">
					...
					<li class="active"><a href="<?php echo base_url(); ?>hama"><i class="fa fa-file"></i> <span>Hama Tanaman</span></a></li>
					...
					<div class="content-wrapper"><section class="content-header">
						<h1>Hama</h1><ol class="breadcrumb">
							...
							<li><a href="<?php echo base_url(); ?>hama">Hama</a> </li>
							<li class="active">Tambah</li></ol></section>
		<section class="content"><div class="row"><div class="col-md-12">
			<div class="box"><div class="box-header with-border"><h3 class="box-title">Tambah Prosedur</h3> </div><div class="box-body">
			<form action="<?php echo base_url(); ?>hama/simpan" class="form-horizontal" id="form-create_group" method="post" accept-charset="utf-8" enctype="multipart/form-data">
				<!-- <div class="form-group">
				<label for="id" class="col-sm-2 control-label">Id Hama</label>
				<div class="col-sm-10">
					<input type="text" name="idhama" value="H" id="id" class="form-control"/>
				</div></div> -->
				<div class="form-group">
				<label for="nama" class="col-sm-2 control-label">Nama</label>
				<div class="col-sm-10">
					<input type="text" name="nama_hama" value="" id="nama" class="form-control"/>
				</div></div>
				<div class="form-group">
				<label for="description" class="col-sm-2 control-label">Deskripsi</label>
				<div class="col-sm-10">
					<textarea type="text" name="uraian_hama" value="" id="description" class="form-control"></textarea>
				...
				<div class="form-group">
				<label for="namha" class="col-sm-2 control-label">Penanggulangan</label>
				<div class="col-sm-10">
					<textarea type="text" name="penanggulangan" value="" id="namha" class="form-control"></textarea>
				</div></div>
				<div class="form-group">
