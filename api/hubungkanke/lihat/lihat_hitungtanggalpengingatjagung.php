...
if ($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    $tgl3 = date('Y-m-d', strtotime($Ipengairan, strtotime($tgl2))); $tgl3_2 = date('Y-m-d', strtotime('+1 days', strtotime($tgl3)));
    ...
    $tgl8 = date('Y-m-d', strtotime($Ipemupukanbwd, strtotime($tgl2))); $tgl8_2 = date('Y-m-d', strtotime('+1 days', strtotime($tgl8)));
    $tgl9 = date('Y-m-d', strtotime($Imonitorhama3, strtotime($tgl2))); $tgl9_2 = date('Y-m-d', strtotime('+1 days', strtotime($tgl9)));
    $tgl10 = date('Y-m-d', strtotime($Ipemupukanbwd2, strtotime($tgl2))); $tgl10_2 = date('Y-m-d', strtotime('+10 days', strtotime($tgl10)));
    $tgl11 = date('Y-m-d', strtotime($Imonitorhama4, strtotime($tgl2))); $tgl11_2 = date('Y-m-d', strtotime('+1 days', strtotime($tgl11)));
    $tgl12 = date('Y-m-d', strtotime($Ipemupukanbwd3, strtotime($tgl2))); $tgl12_2 = date('Y-m-d', strtotime('+1 days', strtotime($tgl12)));
    $tgl13 = date('Y-m-d', strtotime($Ipengairan3, strtotime($tgl12))); $tgl13_2 = date('Y-m-d', strtotime('+1 days', strtotime($tgl13)));
