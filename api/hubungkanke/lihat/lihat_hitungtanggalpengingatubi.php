...
if ($_SERVER['REQUEST_METHOD']=='POST') {
    ...
    $tgl3 = date('Y-m-d', strtotime($Ipengairan, strtotime($tgl2))); $tgl3_2 = date('Y-m-d', strtotime('+10 days', strtotime($tgl3)));
    ...
    $tgl10 = date('Y-m-d', strtotime($Ipemupukanbwd2, strtotime($tgl2))); $tgl10_2 = date('Y-m-d', strtotime('+360 days', strtotime($tgl10)));
