...
public class NotifyServicej6 extends Service {
    ...
    public class ServiceBinder extends Binder {
        NotifyServicej6 getService() {
            return NotifyServicej6.this;
        }
    }
    ...
    public static final String INTENT_NOTIFYj6 = "com.blundell.tut.service.INTENT_NOTIFY";
    // The system notification manager
    private NotificationManager mNM;

    @Override
    public void onCreate() {
        Log.i("NotifyServicej6", "onCreate()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFYj6, false))
            showNotification();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyServicej6.this);

        Intent notifi = new Intent(this,MonitorHamaJaActivity.class);
        notifi.putExtra(NotifyServicej6.EXTRA_ID, 21);
