...
public class NotifyService3 extends Service {
     ...
     */
    public class ServiceBinder3 extends Binder {
        NotifyService3 getService() {
            return NotifyService3.this;
        }
    }

    // Unique id to identify the notification.
    private static final int NOTIFICATION = 1233;
    // Name of an intent extra we can use to identify if this service was started to create a notification
    public static final String INTENT_NOTIFY3 = "com.blundell.tut.service.INTENT_NOTIFY";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFY3, false))
            showNotification();
    ...
    private final IBinder mBinder3 = new ServiceBinder3();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyService3.this);

        Intent notifi = new Intent(this,DetailPengingatActivity.class);
        notifi.putExtra(NotifyService3.EXTRA_ID, 3);
