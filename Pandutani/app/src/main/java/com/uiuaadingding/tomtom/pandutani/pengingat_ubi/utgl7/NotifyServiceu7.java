...
public class NotifyServiceu7 extends Service {
    ...
    public class ServiceBinder extends Binder {
        NotifyServiceu7 getService() {
            return NotifyServiceu7.this;
        }
    }
    ...
    public static final String INTENT_NOTIFYu7 = "com.blundell.tut.service.INTENT_NOTIFY";
    // The system notification manager
    private NotificationManager mNM;

    @Override
    public void onCreate() {
        Log.i("NotifyServiceu7", "onCreate()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFYu7, false))
            showNotification();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyServiceu7.this);

        Intent notifi = new Intent(this,DetailPengingatActivity.class);
        notifi.putExtra(NotifyServiceu7.EXTRA_ID, 48);
