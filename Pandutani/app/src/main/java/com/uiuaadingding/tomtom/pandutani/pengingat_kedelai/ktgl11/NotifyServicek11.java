...
public class NotifyServicek11 extends Service {
    ...
    public class ServiceBinder extends Binder {
        NotifyServicek11 getService() {
            return NotifyServicek11.this;
        }
    }
    ...
    public static final String INTENT_NOTIFYk11 = "com.blundell.tut.service.INTENT_NOTIFY";
    // The system notification manager
    private NotificationManager mNM;

    @Override
    public void onCreate() {
        Log.i("NotifyServicek11", "onCreate()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFYk11, false))
            showNotification();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyServicek11.this);

        Intent notifi = new Intent(this,DetailPengingatActivity.class);
        notifi.putExtra(NotifyServicek11.EXTRA_ID, 39);
