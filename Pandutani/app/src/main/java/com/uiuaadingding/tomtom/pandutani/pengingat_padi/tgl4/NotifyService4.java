...
public class NotifyService4 extends Service {
    protected static String EXTRA_ID = "";

    /**
     * Class for clients to access
     */
    public class ServiceBinder4 extends Binder {
        NotifyService4 getService() {
            return NotifyService4.this;
        }
    }
    ...
    public static final String INTENT_NOTIFY4 = "com.blundell.tut.service.INTENT_NOTIFY";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFY4, false))
            showNotification();
    ...
    private final IBinder mBinder4 = new ServiceBinder4();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyService4.this);

        Intent notifi = new Intent(this,DetailPengingatActivity.class);
        notifi.putExtra(NotifyService4.EXTRA_ID, 4);
        ...
        builder.setSmallIcon(R.drawable.ic_dialog_alert)
                .setContentTitle("Pandutaniwangi").setContentText("Waktunya Pengairan Tahap 2")
