...
import com.uiuaadingding.tomtom.pandutani.d_detailmenu.DetailProsedurActivity;
...
import static com.uiuaadingding.tomtom.pandutani.b_pilihmenu.PilihProsedurActivity.EXTRA_ID;

public class LihatProsedurActivity extends AppCompatActivity implements LihatAdaptor.OnItemClickListener {
    ...
    private static String et_json_url = "http://192.168.43.158/hubungkanke/lihat/lihat_tahapan_prosedur.php";
...
//    private static String et_json_url = "http://192.168.4.106/hubungkanke/lihat/lihat_tahapan_hama.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lihat_prosedur);

        Intent intent = getIntent();
        id = intent.getStringExtra(EXTRA_ID);
//        Toast.makeText(LihatHamaActivity.this, "id "+id, Toast.LENGTH_LONG).show();

        mRecyclerView = findViewById(R.id.rvlihatprosedur);
    ...
    private void parseJSON() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, et_json_url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i=0; i<jsonArray.length(); i++){
                                ...
                                String idd = result.getString("idprosedur");

                                mListLihat.add(new ItemLihat(imgUrl, nama, idd));
                            }

                            mLihatAdaptor = new LihatAdaptor(LihatProsedurActivity.this, mListLihat);
                            mRecyclerView.setAdapter(mLihatAdaptor);
                            mLihatAdaptor.setOnItemClickListener(LihatProsedurActivity.this);

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(LihatProsedurActivity.this, "Gagal " + e.toString(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(LihatProsedurActivity.this, "Gagal meneh " + error.toString(), Toast.LENGTH_SHORT).show();
            }
        })
        {
            @Override
    ...
    public void onItemClick(int position) {
        Intent detail = new Intent(this, DetailProsedurActivity.class);
