...
public class NotifyServicek2 extends Service {
    ...
    public class ServiceBinder extends Binder {
        NotifyServicek2 getService() {
            return NotifyServicek2.this;
        }
    }
    ...
    public static final String INTENT_NOTIFYk2 = "com.blundell.tut.service.INTENT_NOTIFYk2";
    // The system notification manager
    private NotificationManager mNMj2;

    @Override
    public void onCreate() {
        Log.i("NotifyServicek2", "onCreate()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFYk2, false))
            showNotificationj2();
    ...
    private void showNotificationj2() {
        ...
        Notification.Builder builderj2 = new Notification.Builder(NotifyServicek2.this);

        Intent notifij2 = new Intent(this,DetailPengingatActivity.class);
        notifij2.putExtra(NotifyServicek2.EXTRA_ID, 30);
