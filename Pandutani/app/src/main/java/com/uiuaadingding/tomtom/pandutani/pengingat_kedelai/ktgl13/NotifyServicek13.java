...
public class NotifyServicek13 extends Service {
    ...
    public class ServiceBinder extends Binder {
        NotifyServicek13 getService() {
            return NotifyServicek13.this;
        }
    }
    ...
    public static final String INTENT_NOTIFYk13 = "com.blundell.tut.service.INTENT_NOTIFY";
    // The system notification manager
    private NotificationManager mNM;

    @Override
    public void onCreate() {
        Log.i("NotifyServicek13", "onCreate()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFYk13, false))
            showNotification();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyServicek13.this);

        Intent notifi = new Intent(this,DetailPengingatActivity.class);
        notifi.putExtra(NotifyServicek13.EXTRA_ID, 41);
