...
public class NotifyService2 extends Service {
    ...
    public class ServiceBinder2 extends Binder {
        NotifyService2 getService() {
            return NotifyService2.this;
        }
    }

    // Unique id to identify the notification.
    private static final int NOTIFICATION = 1232;
    // Name of an intent extra we can use to identify if this service was started to create a notification
    public static final String INTENT_NOTIFY2 = "com.blundell.tut.service.INTENT_NOTIFY";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFY2, false))
            showNotification();
    ...
    private final IBinder mBinder2 = new ServiceBinder2();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyService2.this);

        Intent notifi = new Intent(this,DetailPengingatActivity.class);
        notifi.putExtra(NotifyService2.EXTRA_ID, 2);
