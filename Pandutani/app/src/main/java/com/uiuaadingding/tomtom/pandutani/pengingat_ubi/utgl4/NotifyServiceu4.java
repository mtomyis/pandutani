...
public class NotifyServiceu4 extends Service {
    ...
    public class ServiceBinder extends Binder {
        NotifyServiceu4 getService() {
            return NotifyServiceu4.this;
        }
    }
    ...
    public static final String INTENT_NOTIFYu4 = "com.blundell.tut.service.INTENT_NOTIFY";
    // The system notification manager
    private NotificationManager mNM;

    @Override
    public void onCreate() {
        Log.i("NotifyServiceu4", "onCreate()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFYu4, false))
            showNotification();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyServiceu4.this);

        Intent notifi = new Intent(this,DetailPengingatActivity.class);
        notifi.putExtra(NotifyServiceu4.EXTRA_ID, 45);
