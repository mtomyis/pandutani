...
public class NotifyService6 extends Service {
    protected static String EXTRA_ID = "";

    /**
     * Class for clients to access
     */
    public class ServiceBinder6 extends Binder {
        NotifyService6 getService() {
            return NotifyService6.this;
        }
    }

    // Unique id to identify the notification.
    private static final int NOTIFICATION = 1236;
    // Name of an intent extra we can use to identify if this service was started to create a notification
    public static final String INTENT_NOTIFY6 = "com.blundell.tut.service.INTENT_NOTIFY";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFY6, false))
            showNotification();
    ...
    private final IBinder mBinder6 = new ServiceBinder6();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyService6.this);

        Intent notifi = new Intent(this,DetailPengingatActivity.class);
        notifi.putExtra(NotifyService6.EXTRA_ID, 6);
