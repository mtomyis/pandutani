...
public class NotifyServiceu10 extends Service {
    ...
    public class ServiceBinder extends Binder {
        NotifyServiceu10 getService() {
            return NotifyServiceu10.this;
        }
    }
    ...
    public static final String INTENT_NOTIFYu10 = "com.blundell.tut.service.INTENT_NOTIFY";
    // The system notification manager
    private NotificationManager mNM;

    @Override
    public void onCreate() {
        Log.i("NotifyServiceu10", "onCreate()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFYu10, false))
            showNotification();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyServiceu10.this);

        Intent notifi = new Intent(this,DetailPengingatActivity.class);
        notifi.putExtra(NotifyServiceu10.EXTRA_ID, 51);
