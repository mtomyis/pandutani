...
public class PilihHamaActivity extends AppCompatActivity implements PilihAdaptor.OnItemClickListener {
...
//    private static String et_json_url = "http://192.168.4.106/hubungkanke/pilih_tanaman.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pilih_hama);

        mRecyclerView = findViewById(R.id.rvpilihhama);
    ...
    private void parseJSON() {
        StringRequest stringRequest = new StringRequest(Request.Method.GET, et_json_url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            mPilihAdaptor = new PilihAdaptor(PilihHamaActivity.this, mListPilih);
                            mRecyclerView.setAdapter(mPilihAdaptor);
                            mPilihAdaptor.setOnItemClickListener(PilihHamaActivity.this);

                        } catch (JSONException e) {
                            e.printStackTrace();
                            Toast.makeText(PilihHamaActivity.this, "Gagal " + e.toString(), Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(PilihHamaActivity.this, "Gagal meneh " + error.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void onItemClick(int position) {
        Intent detail = new Intent(this, LihatHamaActivity.class);
