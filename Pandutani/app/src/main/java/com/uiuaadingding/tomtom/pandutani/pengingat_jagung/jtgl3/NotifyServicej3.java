...
public class NotifyServicej3 extends Service {
    ...
    public class ServiceBinder extends Binder {
        NotifyServicej3 getService() {
            return NotifyServicej3.this;
        }
    }
    ...
    public static final String INTENT_NOTIFYj3 = "com.blundell.tut.service.INTENT_NOTIFY";
    // The system notification manager
    private NotificationManager mNM;

    @Override
    public void onCreate() {
        Log.i("NotifyServicej3", "onCreate()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFYj3, false))
            showNotification();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyServicej3.this);

        Intent notifi = new Intent(this,DetailPengingatActivity.class);
        notifi.putExtra(NotifyServicej3.EXTRA_ID, 18);
