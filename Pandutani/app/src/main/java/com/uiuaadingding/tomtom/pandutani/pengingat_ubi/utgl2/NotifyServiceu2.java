...
public class NotifyServiceu2 extends Service {
    ...
    public class ServiceBinder extends Binder {
        NotifyServiceu2 getService() {
            return NotifyServiceu2.this;
        }
    }
    ...
    public static final String INTENT_NOTIFYu2 = "com.blundell.tut.service.INTENT_NOTIFYu2";
    // The system notification manager
    private NotificationManager mNMj2;

    @Override
    public void onCreate() {
        Log.i("NotifyServiceu2", "onCreate()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFYu2, false))
            showNotificationj2();
    ...
    private void showNotificationj2() {
        ...
        Notification.Builder builderj2 = new Notification.Builder(NotifyServiceu2.this);

        Intent notifij2 = new Intent(this,DetailPengingatActivity.class);
        notifij2.putExtra(NotifyServiceu2.EXTRA_ID, 43);
