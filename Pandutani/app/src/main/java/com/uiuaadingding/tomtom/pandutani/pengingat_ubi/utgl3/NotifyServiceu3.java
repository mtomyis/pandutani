...
public class NotifyServiceu3 extends Service {
    ...
    public class ServiceBinder extends Binder {
        NotifyServiceu3 getService() {
            return NotifyServiceu3.this;
        }
    }
    ...
    public static final String INTENT_NOTIFYu3 = "com.blundell.tut.service.INTENT_NOTIFY";
    // The system notification manager
    private NotificationManager mNM;

    @Override
    public void onCreate() {
        Log.i("NotifyServiceu3", "onCreate()");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if(intent.getBooleanExtra(INTENT_NOTIFYu3, false))
            showNotification();
    ...
    private void showNotification() {
        ...
        Notification.Builder builder = new Notification.Builder(NotifyServiceu3.this);

        Intent notifi = new Intent(this,DetailPengingatActivity.class);
        notifi.putExtra(NotifyServiceu3.EXTRA_ID, 44);
